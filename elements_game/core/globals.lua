...
EXP_LVL = {200, 450, 750, 1100, 1500, 1950, 2450, 2500, 3050, 3700, 4200, 4800, 5400, 6000, 6650, 7300, 8100, 9000, 10000, 11500}
...
function change_exp(value)
	...
	if EXP >= EXP_LVL[LEVEL] then
		...
		print("HEALTH_BLUE", HEALTH_BLUE)
		print("HEALTH_RED", HEALTH_RED)
		print("DAMAGE_BLUE", DAMAGE_BLUE)
		print("DAMAGE_RED", DAMAGE_RED)
		print("HEALTH_PURPLE", HEALTH_PURPLE)
		print("HEALTH_YELLOW", HEALTH_YELLOW)
		print("DAMAGE_PURPLE", DAMAGE_PURPLE)
		print("DAMAGE_YELLOW", DAMAGE_YELLOW)
		print("MONEY_BLUE", MONEY_BLUE)
		print("MONEY_RED", MONEY_RED)
		print("MONEY_PURPLE", MONEY_PURPLE)
		print("MONEY_YELLOW", MONEY_YELLOW)
		print("++++++++++++++++++++++++++++++++++++++")
	end
end
